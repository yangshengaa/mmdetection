"""
image level partition: partition deepfashion2 data set into either shop (commercial) or user (customers)
...
def create_empty_dataset():
    ...
    return dataset
dataset_list = [create_empty_dataset() for _ in range(2)]
...
for dataset, name in zip(dataset_list, ["shop", "user"]):
    json_name = os.path.join(args.path, f'annotation_coco_{name}.json')
